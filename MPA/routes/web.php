...
Route::get("/playlist/create/clear", [SessionPlaylist::class, 'deleteAll']);
Route::get('playlist/edit/{id}', [PlaylistController::class, 'edit']);
Route::get('playlist/add/{id}', [PlaylistController::class, 'add']);
Route::put('playlist/edit/update/{id}', [PlaylistController::class, 'update']);
Route::post('playlist/add/update/{id}', [PlaylistController::class, 'addSong']);
Route::post('playlist/store', [PlaylistController::class, 'store']);
Route::delete('playlist/{playlist_id}/detach/{song_id}', [PlaylistController::class, 'destroy']);
